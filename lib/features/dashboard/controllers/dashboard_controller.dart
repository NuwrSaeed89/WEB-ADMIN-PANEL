...
class DashboardController extends GetxController {
  ...
  void onInit() {
    ...
    print('Initial values set - currentScreen: ${currentScreen.value}');
  ...
  void _loadDashboardData() {
    // TODO: Load data from API or local storage
  ...
  void changeScreen(String screenName) {
    print('Changing screen from ${currentScreen.value} to $screenName');
    if (currentScreen.value != screenName) {
      currentScreen.value = screenName;
      print('Screen changed to: ${currentScreen.value}');
